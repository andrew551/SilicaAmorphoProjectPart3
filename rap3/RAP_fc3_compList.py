...
folder="Results"
output_file=folder+"/fc3_%d.hdf5"%(me)
...
if me < cL_length%nprocs:
    ind_nums=cL_length//nprocs+1
    ind_start=me*(cL_length//nprocs+1)
else:
    ind_nums=cL_length//nprocs
    ind_start=me*(cL_length//nprocs)+cL_length%nprocs
...
def write_fpp(output_file,fc3,my_ind,me,ind_cp=0):
...
if __name__ == "__main__":
    ...
    #Regional calculation
        ...
        print('Force neighbour list completed')
    ...
    if WRITE_OUT_TYPE==0:
        write_fpp(output_file,fc3,my_ind,me)
